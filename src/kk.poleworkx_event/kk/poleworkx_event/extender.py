...
from Products.Archetypes.public import StringField, BooleanField, TextField
from Products.Archetypes.public import StringWidget, BooleanWidget, RichWidget
...
class EventExtender(object):
    ...
    fields = [
       ...
       CourseBlockDetailsField(
            "courseblockdetails",
            languageIndependent=False,
            default_output_type='text/x-html-safe',
            widget=RichWidget(
                label="Kursblock details"
            )
        ),
        TotalSeatsField(
            "totalseats",
    ...
    def getOrder(self, schematas):
        schematas['default'] = ['id', 'title', 'description', 'courseblock',
                                'courseblockdetails', 'location', 'startDate',
                                'endDate', 'totalseats', 'bookedseats',
                                'price', 'discountedprice', 'avaliable',
                                'text', 'attendees', 'eventUrl', 'contactName',
